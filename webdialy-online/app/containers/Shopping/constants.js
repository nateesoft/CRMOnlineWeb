...
export const LOAD_CART = 'app/Shopping/LOAD_CART';
export const LOAD_CART_SUCCESS = 'app/Shopping/LOAD_CART_SUCCESS';
export const LOAD_CART_ERROR = 'app/Shopping/LOAD_CART_ERROR';
